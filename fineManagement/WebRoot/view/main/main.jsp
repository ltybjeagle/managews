...
<script type="text/javascript" src="<%=basePath%>/js/commons/changedata.js"></script>
</head>
<body class="easyui-layout">
<div class="ui-header" data-options="region:'north',border:false" style="height:68px;overflow: hidden;">
<div class="header">
<div class="logo fleft">
    <img src="<%=basePath%>/plug-in/login/images/loginlogo-01.png" />
</div>
<div id="Headermenu">
	<ul id="topnav">
...
<div id="modify-pwd-win"  class="easyui-dialog" buttons="#editPwdbtn" title="修改用户密码" 
	data-options="closed:true,iconCls:'icon-save',modal:true" style="width:560px;height:460px;">
