	...
	<form id="editForm" class="ui-form" method="post" enctype="multipart/form-data"> 
		...
		<div class="ui-edit">
			...
			<div class="fitem">  
       		...
       		<div class="fitem">  
           		<label>采收人:</label>  
           		<input class="easyui-validatebox" id="harveststaff" name="harveststaff"  data-options="width:282"/>
       		</div>
       		<div class="fitem">  
           		<label>验收人:</label>  
...
<script type="text/javascript" src="<%=basePath%>/js/ux/pick/pickplants.js"></script>
<script type="text/javascript" src="<%=basePath%>/js/ux/pick/changedataplants.js"></script>
</body>
</html>