	...
	<form id="editForm" class="ui-form" method="post"> 
		...
		<div class="ui-edit">
			<div class="ftitle">传感器设置</div>    
       		...
       		<div class="fitem">  
           		<label>采集点:</label>  
           		<input class="easyui-validatebox" type="text" name="acquisitionPoint" data-options="required:true"/>
       		</div>
       		<div class="fitem">  
            	<label>所属基地:</label>  
 	...
 	<form id="pwdForm" class="ui-form" method="post">  
 		<div class="ui-edit">
  	   		...
  	   		<table id="query_table_win">
  	   			...
  	   			<tr><td><label>采集点:</label></td><td><span id="acquisitionPoint"></span></td></tr>
...
<script type="text/javascript" src="<%=basePath%>/js/ux/iot/sysSensor.js"></script>
<script type="text/javascript" src="<%=basePath%>/js/ux/iot/changedataSensor.js"></script>
</body>
</html>