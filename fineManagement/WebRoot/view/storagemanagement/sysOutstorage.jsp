...
<div id="edit-win" class="easyui-dialog" title="Edit" data-options="closed:true,iconCls:'icon-save',modal:true" 
	...
	<form id="editForm" class="ui-form" method="post"> 
		...
		<div class="ui-edit">
			...
			<div class="fitem">  
           		<label>加工批次:</label>  
           		<select class="easyui-combobox" id="batchprocessings" name="batchprocessings" required="true" 
			...
			<div class="fitem">  
       		...
       		<div class="fitem">  
           		<label>仓库:</label>  
           		<select class="easyui-combobox" id="warehouseid" name="warehouseid" data-options="width:141">
           		</select>
       		</div>
       		<div class="fitem">  
           		<label>入库时间:</label>  
       		...
       		<div class="fitem">  
           		<label>出库时间:</label>  
           		<input class="easyui-datebox" type="text" name="outstoretime"/>
       		</div> 
       		<div class="fitem">  
            	<label>备注:</label>  
