...
<!-- Edit Form -->
<div id="edit-win" class="easyui-dialog" title="物资领用确认" data-options="closed:true,iconCls:'icon-save',modal:true" 
	...
	<form id="editForm" class="ui-form" method="post"> 
		...
		<div class="ui-edit">
			...
			<div class="fitem" style="visibility: none;">    
       		...
       		<div class="fitem">  
           		<label>物资名称:</label>  
           		<input class="easyui-validatebox" type="text" readonly="true" id="materialname" name="materialname" 
           			style="background-color:#d0d0d0"/>
       		</div>
         	<div class="fitem">  
           		<label>领用数量:</label>  
           		<input class="easyui-validatebox" type="text" name="consumcount" data-options="required:true"/>
       		</div>
       		<div class="fitem">  
           		<label>单价(元):</label>  
       		...
       		<div class="fitem">  
           		<label>使用人:</label>  
           		<input class="easyui-validatebox" type="text" name="materialuser" />
       		</div>
       		<div class="fitem">  
           		<label>负责人:</label>  
...
<script type="text/javascript" src="<%=basePath%>/js/ux/materialmanage/sysMaterialConsum.js"></script>
</body>
</html>