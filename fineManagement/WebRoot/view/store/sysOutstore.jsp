...
<div id="edit-win" class="easyui-dialog" title="Edit" data-options="closed:true,iconCls:'icon-save',modal:true" 
	...
	<form id="editForm" class="ui-form" method="post"> 
		...
		<input class="hidden" type="text" name="inputid" id="inputid">
		<div class="ui-edit">
			<div class="ftitle">出库确认</div>
       		<div class="fitem">  
           		<label>仓库:</label>  
			...
			<div class="fitem">  
       		...
       		<div class="fitem">  
            	<label>备注:</label>  
             	<input class="easyui-validatebox" name="remark"/>
         	</div>
		</div>
	</form>
</div>
...
<script type="text/javascript" src="<%=basePath%>/js/ux/store/sysOutstore.js"></script>
</body>
</html>