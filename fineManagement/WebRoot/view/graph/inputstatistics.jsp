...
<div class="ui-search-panel" region="north" style="height:100px"  title="过滤条件" 
	...
	<div>
			<p class="ui-fields">	    				
			<label class="ui-label">商品编号:</label><input name="productid" id="productid" class="easyui-box ui-text"   missingMessage="商品编号必须填写" style="width:100px;">
	    	</p>
	     	<p class="ui-fields">	 		
			<label class="ui-label">投入品名称:</label><input name="inputid" id="inputid" class="easyui-combobox"  missingMessage="投入品名称必须填写" style="width:100px;">
	    	 </p>
	     	<p class="ui-fields">		
			<label class="ui-label">使用基地:</label><input name="baseid" id="baseid" class="easyui-combobox" style="width:100px;">
			</p>
			<p class="ui-fields">
			<label class="ui-label"  style="float:left">使用大棚:</label><input name="greehouseids" id="greehouseids" class="easyui-combobox" style="width:100px;float:left">
	   		</p>
...
<div  region="center" border="false" style="overflow:auto">
  <div class="easyui-layout"  style=" height:850px;width:98%">
        ...
        <div id="container1"  region="center" style="height:50%">
