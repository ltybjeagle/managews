      ...
      //  url:'/statisticsInputs/inputtable.do',
		...
		loadMsg:  'Loading in ...',
	     columns:[[   
          ...
          {field:'variety',title:'菜品名称',width:100},
          {field:'baseName',title:'基地',width:100},
          {field:'name',title:'大棚',width:100},
...
$('#btn-search').bind('click',function(){
	var te=new Object();
	te.text="菜品名称:"+$('#plantids').combobox('getText')+"\n统计时间:"+$('#sd').val()+"至"+$('#ed').val()+"使用基地："+$('#baseid').combobox('getText')+"  使用大棚："+$('#greenhouseids').combobox('getText');
	options.title=te;	
    var dec= $("#searchForm").serializeObject();
	var ss=$("#easyui-datebox").val();
    var url =  "../statisticsInputs/harvesttable.do";
