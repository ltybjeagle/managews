$package('finems.sysGreenhouseType');
finems.sysGreenhouseType = function() {
	var _box = null;
	var _this = {
			config: {
				event: {
				...
				dataGrid: {
					...
					columns: [[
					           ...
					           {field: 'greenhouseName', title: '大棚类型名称', width: 200, sortable: true},
					           {field: 'greenhouseCount', title: '大棚数量', width: 120, sortable: true},
