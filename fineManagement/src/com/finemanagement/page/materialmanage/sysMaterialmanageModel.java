...
public class sysMaterialmanageModel extends BasePage {
	...
	private String instoretimestart;
	private String instoretimeend;
	private String consumtimestart;
	private String consumtimeend;
	...
	public String getInstoretimestart() {
		return instoretimestart;
	}
	public void setInstoretimestart(String instoretimestart) {
		this.instoretimestart = instoretimestart;
	}
	public String getInstoretimeend() {
		return instoretimeend;
	}
	public void setInstoretimeend(String instoretimeend) {
	...
	public String getConsumtimestart() {
		return consumtimestart;
	}
	public void setConsumtimestart(String consumtimestart) {
		this.consumtimestart = consumtimestart;
	}
	public String getConsumtimeend() {
		return consumtimeend;
	}
	public void setConsumtimeend(String consumtimeend) {
		this.consumtimeend = consumtimeend;
	}
