 ...
 * @author liutianyang
 */
public class SysTaskBreedModel extends BasePage {
	...
	/**
	 * @param breedTechnician
	 *            the breedTechnician to set
	 */
	...
	/**
	 * @param breedTechnicianName
	 *            the breedTechnicianName to set
	 */
