...
public class SysVideoService<T> extends BaseService<T> {

	@Autowired
	private SysVideoDao<T> sysVideoDao;
	
	public SysVideoDao<T> getDao() {
		return sysVideoDao;
	}
	
	@Override
	public String getMapperObj() {
		return "com.finemanagement.dao.iot.SysVideoDao";
	}
}
