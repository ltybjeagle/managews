...
public class SysIdentifierAction extends BaseAction {
	...
	public void loadIdentifierList(HttpServletResponse response) throws Exception {
		List<SysIdentifier> identifierList = sysIdentifierService.querySysIdentifierList();
