$package('finems.sysBase');
finems.sysBase = function() {
	var _box = null;
	var _this = {
			config: {
				event: {
				...
				dataGrid: {
					...
					columns: [[
					           ...
					           {field: 'baseName', title: '基地名称', width: 200, sortable: true},
					           {field: 'responsible', title: '责任人', width: 120, sortable: true},
					           {field: 'baseArea', title: '基地面积（亩）', width: 150, sortable: true},
					           {field: 'baseAddress', title: '基地地址', width: 300, sortable: true},
