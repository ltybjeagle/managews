$package('finems.sysManufacturer');
finems.sysManufacturer = function() {
	var _box = null;
	var _this = {
			config: {
				event: {
				...
				dataGrid: {
					...
					columns: [[
					           ...
					           {field: 'mfArea', title: '厂家地址', width: 280, sortable: true},
					           {field: 'mfPhoneNo', title: '联系方式', width: 120, sortable: true},
