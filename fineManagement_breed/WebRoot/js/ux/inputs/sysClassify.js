$package('finems.sysClassify');
finems.sysClassify = function() {
	var _box = null;
	var _this = {
			config: {
				event: {
				...
				dataGrid: {
					...
					columns: [[
					           ...
					           {field: 'classname', title: '分类名称', width: 220, sortable: true},
					           {field: 'sort', title: '排序', width: 120, sortable: true},
