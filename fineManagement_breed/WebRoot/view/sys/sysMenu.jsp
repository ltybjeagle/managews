...
<!-- Edit Win&From -->
<div id="edit-win" class="easyui-dialog" title="Edit Menu" data-options="closed:true,iconCls:'icon-save',modal:true"  
	...
	<form id="editForm" class="ui-form" method="post"> 
		...
		<div class="easyui-panel" border='false' style="width:450px;height: 350px;">  
   			<div class="easyui-layout" data-options="fit:true">
       			<div data-options="region:'north',split:true" style="height:198px;padding:10px">  
          			<div class="ftitle">详细</div>
          			<div class="fitem">  
             			<label>系统选择:</label>  
             			<select class="easyui-combobox" id="sysids" name="sysids" data-options="width:141"></select>
         			</div>
       				<div class="fitem">  
           				<label>名称:</label>  
       			...
       			<div data-options="region:'center'">  
         			<div id="toolbar">  
      					<a href="javascript:void(0)" id='addLine_btn' class="easyui-linkbutton" 
      						iconCls="icon-add" plain="true" >Add</a>  
      					<a href="javascript:void(0)" id='addDefLine_btn'class="easyui-linkbutton" 
      						iconCls="icon-add" plain="true" >AddDefault</a>
      					<a href="javascript:void(0)" id='delAllLine_btn'class="easyui-linkbutton" 
      						iconCls="icon-remove" plain="true" >Delete All</a>  
	  				</div>  
