...
<div class="ui-search-panel" region="north" style="height: 80px;" title="过滤条件" 
	...
	<form id="searchForm">
		<p class="ui-fields">
			<label class="ui-label">基地名称:</label><input name="baseName" class="easyui-box ui-text" style="width:100px;">
	   	</p>
	...
	<form id="editForm" class="ui-form" method="post"> 
		...
		<div class="ui-edit">
			<div class="ftitle">基地信息</div>    
       		<div class="fitem">  
           		<label>基地名称:</label>  
           		<input class="easyui-validatebox" type="text" name="baseName" data-options="required:true"/>
       		</div>
       		<div class="fitem">  
           		<label>基地地址:</label>  
           		<input class="easyui-validatebox" type="text" name="baseAddress" data-options="required:true"/>
       		</div>
       		<div class="fitem">  
           		<label>基地面积（亩）:</label>  
           		<input class="easyui-validatebox" type="text" name="baseArea" data-options="required:true"/>
       		</div>
       		<div class="fitem">  
            	<label>负责人:</label>  
 	...
 	<form id="pwdForm" class="ui-form" method="post">  
 		<div class="ui-edit">
  	   		...
  	   		<table id="query_table_win">
  	   			<tr><td><label>基地名称:</label></td><td><span id="baseName"></span></td></tr>
  	   			<tr><td><label>基地地址:</label></td><td><span id="baseAddress"></span></td></tr>
  	   			<tr><td><label>基地面积（亩）:</label></td><td><span id="baseArea"></span></td></tr>
  	   			<tr><td><label>负责人:</label></td><td><span id="responsible"></span></td></tr>
  	   			<tr><td><label>联系方式:</label></td><td><span id="phoneNo"></span></td></tr>
  	   			<tr><td><label>建设时间:</label></td><td><span id="createTime"></span></td></tr>
...
<div id="allmap" class="easyui-dialog" title="Basic Dialog" data-options="closed:true,iconCls:'icon-save'" 
	style="width:500px;height:400px;padding:10px">
	</div>
<script type="text/javascript" src="<%=basePath%>/js/ux/basic/sysBase.js"></script>
<script type="text/javascript" src="<%=basePath%>/js/ux/basic/changedataBase.js"></script>
