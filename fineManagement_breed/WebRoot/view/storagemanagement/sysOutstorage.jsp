...
<div id="edit-win" class="easyui-dialog" title="Edit" data-options="closed:true,iconCls:'icon-save',modal:true" 
	...
	<form id="editForm" class="ui-form" method="post"> 
		...
		<input class="hidden" type="text" name="batchprocessing" id="batchprocessing">
		<div class="ui-edit">
			<div class="ftitle">成品出库信息</div>
			<div class="fitem">  
           		<label>加工批次:</label>  
           		<select class="easyui-combobox" id="batchprocessings" name="batchprocessings" data-options="required:true,editable:false,panelHeight:'auto'"
			...
			<div class="fitem">  
       		...
       		<div class="fitem">  
           		<label>入库时间:</label>  
           		<input class="easyui-validatebox" type="text" readonly="true" id="instoretime" name="instoretime" 
           			style="background-color:#d0d0d0"/>
       		</div>
       		<div class="fitem">  
           		<label>仓库:</label>  
       		...
       		<div class="fitem">  
           		<label>出库时间:</label>  
           		<input class="easyui-datebox" type="text" id="outstoretime" name="outstoretime"/>
       		</div> 
       		<div class="fitem">  
            	<label>备注:</label>  
 	...
 	<form id="pwdForm" class="ui-form" method="post">  
 		<div class="ui-edit">
  	   		...
  	   		<table id="query_table_win">
  	   			...
  	   			<tr><td><label>出库负责人:</label></td><td><span id="principal_q"></span></td></tr>
  	   			<tr><td><label>出库时间:</label></td><td><span id="outstoretime_q"></span></td></tr>
...
<script type="text/javascript" src="<%=basePath%>/js/ux/storagemanagement/sysOutStorage.js"></script>
<script type="text/javascript" src="<%=basePath%>/js/ux/storagemanagement/changedataOutStorage.js"></script>
</body>
</html>