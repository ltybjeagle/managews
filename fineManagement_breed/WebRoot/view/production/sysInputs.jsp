	...
	<form id="editForm" class="ui-form" method="post">
		...
		<div class="ui-edit">
			<div class="ftitle">投入品信息</div>    
       		<div class="fitem">  
           		<label>商品编号:</label>  
           		<select class="easyui-combobox" id="productNos" name="productNos" data-options="required:true,editable:false,panelHeight:'auto'" 
...
<script type="text/javascript" src="<%=basePath%>/js/ux/production/sysInputs.js"></script>
<script type="text/javascript" src="<%=basePath%>/js/ux/production/changedatainputs.js"></script>
</body>
</html>