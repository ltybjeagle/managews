...
<div class="ui-search-panel" region="north" style="height: 80px;" title="过滤条件" 
	...
	<form id="searchForm">
		<p class="ui-fields">
	   	...
	   	<p class="ui-fields">
			<label class="ui-label">禽舍:</label>
			<select class="easyui-combobox" id="fowleryids" name="fowleryids" style="width:100px;"></select>
	   	</p>
	...
	<form id="editForm" class="ui-form" method="post" enctype="multipart/form-data"> 
		...
		<div class="ui-edit">
			...
			<div class="fitem">  
         	...
         	<div class="fitem">  
            	<label>禽舍名称:</label>  
             	<select class="easyui-combobox" id="fowleryid" name="fowleryid" data-options="required:true,editable:false,panelHeight:'auto'" 
             		style="padding:2px;width:141px;">
           		</select>
         	</div>
       		<div class="fitem">  
 	...
 	<form id="pwdForm" class="ui-form" method="post">  
 		<div class="ui-edit">
  	   		...
  	   		<table id="query_table_win">
  	   			...
  	   			<tr><td><label>禽舍名称:</label></td><td><span id="greenhouseName_q"></span></td></tr>
