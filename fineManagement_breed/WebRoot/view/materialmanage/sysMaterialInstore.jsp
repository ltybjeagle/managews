...
<!-- Edit Form -->
<div id="edit-win" class="easyui-dialog" title="物资入库确认" data-options="closed:true,iconCls:'icon-save',modal:true" 
	...
	<form id="editForm" class="ui-form" method="post"> 
		...
		<div class="ui-edit">
			...
			<div class="fitem" >    
         	...
         	<div class="fitem">  
           		<label>入库数量:</label>  
           		<input class="easyui-validatebox" type="text" name="storecount" data-options="required:true"/>
       		</div>
       		<div class="fitem">  
           		<label>单价(元):</label>  
...
<script type="text/javascript" src="<%=basePath%>/js/ux/materialmanage/sysMaterialInstore.js"></script>
</body>
</html>