...
<div class="ui-search-panel" region="north" style="height: 80px;" title="过滤条件" 
	...
	<form id="searchForm">
		<p class="ui-fields">
	   	...
	   	<p class="ui-fields">
			<label class="ui-label">领用时间:</label><input name="consumtimestart" type="text" class="easyui-datebox" style="width:100px;">
			<label class="ui-label">至</label><input name="consumtimeend" type="text" class="easyui-datebox" style="width:100px;">
	   	</p>
	...
	style="width:560px;height:430px;">
 	<form id="pwdForm" class="ui-form" method="post">  
 		<div class="ui-edit">
        	...
        	<div class="ftitle">领用信息</div>    
        	<table id="store">
  	   			<tr><td><label>领用数量:</label></td><td><span id="consumcount"></span></td>
  	   			<td><label>领用时间:</label></td><td><span id="consumtime"></span></td></tr>
...
<script type="text/javascript" src="<%=basePath%>/js/ux/materialmanage/sysMaterialConsumDetail.js"></script>
</body>
</html>