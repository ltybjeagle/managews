...
<div class="ui-search-panel" region="north" style="height: 80px;" title="过滤条件" 
	...
	<form id="searchForm">
		<p class="ui-fields">
	   	...
	   	<p class="ui-fields">
			<label class="ui-label">入库时间:</label><input name="instoretimestart" type="text" class="easyui-datebox" style="width:100px;">
			<label class="ui-label">至</label><input name="instoretimeend" type="text" class="easyui-datebox" style="width:100px;">
	   	</p>
	...
	style="width:560px;height:430px;">
 	<form id="pwdForm" class="ui-form" method="post">  
 		<div class="ui-edit">
        	...
        	<table id="store">
  	   			<tr><td><label>入库数量:</label></td><td><span id="storecount"></span></td>
...
<script type="text/javascript" src="<%=basePath%>/js/ux/materialmanage/sysMaterialInstoreDetail.js"></script>
</body>
</html>